...
import { AlbumDiscovery } from './AlbumDiscovery'
  ...
  setup() {
    ...
    return () => (
      <div class="flex h-dvh flex-col overflow-auto">
        {!searched.value && (
          <div class="mx-auto flex w-full max-w-[886px] 2xl:mt-[20dvh] px-4 py-12 sm:px-6 sm:py-16">
            <SearchBar
        ...
        <AlbumDiscovery active={!searched.value} />
        {searched.value && (
          <PageHeader
            v-model={keyword.value}
            busy={searchApi.loading}
